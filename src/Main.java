public class Main {
    ...
    public static void main(String[] args) {
        ...
        Balance balance1 = new Balance(1, 1, 1, 1);
        Consequence conséquence1 = new Consequence(balance1, 5, null);
        Choix choix1 = new Choix("Vous déclinez l'offre.", conséquence1);

        Balance balance2 = new Balance(0, 2, 3, 1);
        Consequence conséquence2 = new Consequence(balance2, 1, null);
        ...
        Balance balanceJeu = new Balance(6, 6, 6, 6);
